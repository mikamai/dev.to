...
ProveKeybase.setup do |config|
  ...
  config.domain = 'https://matteojoliveau-devto.localtunnel.me'
  config.display_name = 'DEV'
  ...
  # proofs.
  config.profile_url = "https://matteojoliveau-devto.localtunnel.me/%{username}"

  config.description = 'DEV'
  config.brand_color = '#000000'
  ...
  config.login_redirection = :new_user_session
...
ProveKeybase::Configuration.class_eval do
